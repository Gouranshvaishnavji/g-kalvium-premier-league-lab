...
try {
  ...
  console.log('Bhai! kya kar rha hai...');
...
//  kala samajh kapda mangaya x2 mai to bhaishaya charat 
...
function filterByNoOfAwardsxTeamxAge(noOfAwards, team, age) {
  var filteredData = players.filter(player => (
...
function sortByNamexOlderThan(age) {
  ...
  return filteredData.sort(compared);
}
